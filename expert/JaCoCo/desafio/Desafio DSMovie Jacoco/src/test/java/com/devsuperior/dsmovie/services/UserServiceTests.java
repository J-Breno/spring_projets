...
public class UserServiceTests {
	...
	private List<UserDetailsProjection> users;
	...
	public void setUp() throws Exception {
		...
		users = UserDetailsFactory.createCustomAdminUser(existingUsername);
		...
		Mockito.when(repository.searchUserAndRolesByUsername(existingUsername)).thenReturn(users);
	...
	public void authenticatedShouldReturnUserEntityWhenUserExists() {
		...
		UserEntity userEntity = service.authenticated();
		Assertions.assertNotNull(userEntity);
		Assertions.assertEquals(existingUsername, userEntity.getUsername());
	}
