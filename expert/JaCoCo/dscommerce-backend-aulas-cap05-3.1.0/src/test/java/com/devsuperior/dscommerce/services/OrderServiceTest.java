...
public class OrderServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        admin = UserFactory.createCustomAdimUser(1L, "Jef@gmail.com");
    ...
    @Test
    public void insertShouldReturnOrderDTOWhenIdExistsAndAdminLogged() {
    ...
    @Test
    public void insertShouldReturnOrderDTOWhenIdExistsAndClientLogged() {
    ...
    @Test
    public void insertShouldThrowEntityNotFoundExceptionWhenIdDoesNotExists() {
        Mockito.when(userService.authenticated()).thenReturn(client);
