...
public class UserDetailsFactory {
    ...
    public static List<UserDetailsProjection> createCustomAdimUser(String username) {
        List<UserDetailsProjection> list = new ArrayList<>();
        list.add(new UserDetailsImpl(username, "123", 2L, "ROLE_ADIM"));
        return list;
    }

    public static List<UserDetailsProjection> createCustomClientAdimUser(String username) {
        List<UserDetailsProjection> list = new ArrayList<>();
